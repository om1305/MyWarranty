...
//             <Form.Group controlId="formPassword2" className="mb-4">
//               <Form.Label>Confirm Password</Form.Label>
//               <Form.Control
//                 type="password"
//                 placeholder="Confirm Password"
...
const Signup = () => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      // direct dashboard
navigate('/dashboard');
      // if register response contains token + user, go directly to dashboard
    //   if (data?.accessToken && data?.user) {
    //     navigate('/dashboard');
    //   } else {
    //     // fallback if backend only returns success message
