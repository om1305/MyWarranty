              ...
              <Form onSubmit={onSubmit}>
                ...
                {imageUrl && (
                  <div className="mb-3 text-success">
                    <strong>Uploaded File Ready:</strong> {imageUrl}
                  </div>
                )}
          ...
          <Card className="shadow-sm">
            <Card.Body className="text-center">
              ...
              >
                <FaUpload size={40} className="mb-3" style={{ color: '#007bff' }} />
                <p className="mb-1">Click to upload or drag and drop</p>
                <p className="text-muted mb-0">Upload receipt or warranty card image</p>
                ...
                {uploading && <p className="mt-2">Uploading file...</p>}
              </div>
